...
public class ValueWrapper {
	 ...
	 */
	private static final BiFunction<Integer, Integer, Integer> INTEGER_SUBTRACTOR = (a1, a2) -> Integer.valueOf(a1 - a2);
	private static final BiFunction<Double, Double, Double> DOUBLE_SUBTRACTOR = (a1, a2) -> Double.valueOf(a1 - a2);

	/**
	 * product functions
	 */
	private static final BiFunction<Integer, Integer, Integer> INTEGER_MULTIPLIER = (a1, a2) -> Integer.valueOf(a1 * a2);
	...
	private static final BiFunction<Double, Double, Double> DOUBLE_COMPARATOR = (a1, a2) -> (double) Double.compare(a1, a2);
