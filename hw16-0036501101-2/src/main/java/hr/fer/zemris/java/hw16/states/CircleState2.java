 ...
 * start drawing the circle. This state awaits the second user click to
 * finalize the circle and add it to the drawing model.
 * 
 * @author Disho
 *
 */
public class CircleState2 extends AbstractState {
	/**
	 * circle that is being drawn
	 */
	 ...
	 * @param circle circle that is being drawn
	 */
	public CircleState2(JVDraw context, Circle circle) {
		super(context);
		this.circle = circle;
	}
	...
	public void mouseClicked(MouseEvent e) {
		...
		context.setToolState(new CircleState1(context));
	}
